...
class InjuryReportModel(mlbdb.Model):
    ...
    @staticmethod
    def update_injury_report(injury_report_id, players, date, return_as_model=False):
    ...
    def create_injury_report(players, date):
        injury_report_models = InjuryReportModel.get_all_injury_reports(players=players, date=date)
        ...
        injury_report_model = InjuryReportModel(injury_report_id=injury_report_id, players=players, date=date)
    ...
    def delete_injury_report(injury_report_id):
        injury_report_model = InjuryReportModel.get_injury_report_by_id(injury_report_id=injury_report_id, return_as_model=True)
